...
def main():
    ...
    # qstree.print_nodes()
    # print('\ncoalescent:')
    # coalescent_process = qstree.sub_coalescent(distance_at_root=2, lambda0=0.3, sub_leaves=[0,1])
    # print('\ncoalescent_process:')
    # pprint.pprint(coalescent_process)
    # print('\ntime_sequences:')
    # time_sequences = qstree.time_sequences(coalescent_process=coalescent_process)
    ...
    dup_events = qgtree.dup_loss_process(lambda_dup=0.2, lambda_loss=0.05)
